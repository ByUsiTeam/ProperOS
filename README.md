...
├── README.md
├── apk/
│ ├── LookAtMe_LookAtMe_LookAtMe.TXT
│ ├── assets/
│ │ ├── 123pan.Json
│ │ └── extra_conf1g.xml
│ └── lib/
...
│     └── zip
├── bin/
│ ├── miao.byusi.properos.apk
│ └── miao.byusi.properos_dp.apk
├── icon.png
├── res/
│ ├── 100.gif
│ ├── ByUsi/
...
│ │ │ └── WeChat/
│ │ │     └── sponsor/
│ │ │         └── mm_reward_qrcode_1724656864916.png
│ │ ├── sdk/
│ │ │ ├── player.bysi.sdk
│ │ │ └── yy.jsdk
│ │ └── src/
...
│ │     └── yybfq/
│ │         └── jc.zip
│ ├── JuOS_Third-party_Configuration/
│ │ └── config.json
│ ├── ProperOS/
│ │ ├── Src/
│ │ │ ├── Logo/
...
│ │ └── z_x.TTF
│ ├── hello.json
│ ├── ic_desktop_lyrics.png
│ ├── ic_no_favorite.png
│ ├── ic_play_next_regular.png
│ ├── ic_play_pause_regular.png
│ ├── ic_play_playlast_regular.png
│ ├── image_error.jpg
│ ├── jsonui.json
│ ├── l9.png
│ ├── ll9.png
...
└── src/
    ...
    ├── GGExpanded.myu
    ├── Glide.mjava
    ├── JointDevelopmentNotificationList.iyu
    ├── JuOS.terminal.iyu
    ├── JuOS_Hemo.iyu
    ├── Lottie.myu
    ├── Lottie动画测试.iyu
